...
/* USER CODE BEGIN 0 */
extern uint8_t g_ucMode ; //灏忚溅杩愬姩妯″紡鏍囧織浣?
/* USER CODE END 0 */
...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, AIN1_Pin|DHT11_Pin|BIN1_Pin|HC_SR04_Trig_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin */
  GPIO_InitStruct.Pin = AIN1_Pin|DHT11_Pin|BIN1_Pin|HC_SR04_Trig_Pin
                          |SCL_6050_Pin|SDA_6050_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
